...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    It also creates elements in 3 namespaces:
            1. http://www.daisy.org/z3986/2005/ncx/
            2. http://www.idpf.org/2007/opf
    ...
    <!-- The following ___6 manifest_ templates are affecting the resulting opf file. -->
    <!-- This type of template is common in XSLT because it keeps ___contents_ while removing __container element__. -->
    ...
    <!-- Lots of templates creating xhtml from the source document. -->
    ...
    <!-- Among the below templates I add a couple classes: right and footnotes, so I need to remember to treat them in the CSS.-->
